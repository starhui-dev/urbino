...
统一 `/admin/v1`，独立管理 listener，OpenAPI 契约、错误类型、分页与幂等规则完整。
...
二进制子命令至少：serve、worker、migrate、bootstrap、version、config validate、health、admin（资源子命令）、doctor、ledger verify。
